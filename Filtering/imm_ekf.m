function [XHAT, PHAT, MU] = imm_ekf(z, u, A1, A2, B, C, Q, R, check, Alin, A0, Clin) % IMM function
...
[xhatk(:,2), Phatk(:,:,2), likelihood(2,1)] = ekf_atc_imm(xMix(:,2), z, u, PMix(:,:,2), A2, Alin, A0, B, C, Clin, Q, R); % Calls the KF using A2

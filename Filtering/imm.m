function [XHAT, PHAT, MU] = imm(z, u, A1, A2, B, C, Q, R, check) % IMM function
...
if check == 1
    xhat = z; % Defines estimate vector to measurements
...
[xhatk(:,2), Phatk(:,:,2), likelihood(2,1)] = kf_imm(xMix(:,2), z, u, PMix(:,:,2), A2, B, C, Q, R); % Calls the KF using A2

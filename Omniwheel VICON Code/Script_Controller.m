...
%% Processing the data in real time
    ...
    kp = [0.05,0.05,0.2;+0.05,-0.05,0.2;-0.05,-0.05,0.2;-0.05,0.05,0.2];
    ki = [0.03,0.03,0.01;0.03,-0.03,0.01;-0.03,-0.03,0.01;-0.03,+0.03,0.01]./10;
